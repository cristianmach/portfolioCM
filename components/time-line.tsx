            ...
            <div className="w-full max-w-3xl mx-auto md:pb-40 md:pt-20">
                <div className="-my-6">
                    {dataAboutPage.map((data) => (
                        <div key={data.id} className="relative py-6 pl-8 sm:pl-32 group md:pr-56 lg:pr-64">
                            ...
                            <div className="flex flex-col sm:flex-row items-start mb-1 
                                ...
                                <time className="sm:absolute left-0 translate-y-0.5 inline-flex items-center justify-center text-xs font-semibold uppercase w-20 h-6 mb-3 sm:mb-0 bg-secondary rounded-full">{data.date}</time>
                                <div className="text-lg font-bold text-gray-400">{data.subtitle}</div>
                            </div>
